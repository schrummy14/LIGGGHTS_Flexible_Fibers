...
#ifdef NORMAL_MODEL
NORMAL_MODEL(VOIGT,voigt,5)
#else
#ifndef NORMAL_MODEL_VOIGT_H_
#define NORMAL_MODEL_VOIGT_H_
...
namespace ContactModels
{
  ...
  template<>
  class NormalModel<VOIGT> : public NormalModelBase
  {
  public:
    ...
    void registerSettings(Settings & settings)
    {
      ...
      settings.registerOnOff("tangential_damping", tangential_damping, false);
      settings.registerOnOff("limitForce", limitForce);
      settings.registerOnOff("heating_normal_voigt",heating,false);
    ...
    void connectToProperties(PropertyRegistry & registry)
    {
      ...
      registry.registerProperty("Yeff", &MODEL_PARAMS::createYeff,"model voigt");
      registry.registerProperty("Geff", &MODEL_PARAMS::createGeff,"model voigt");
      registry.registerProperty("betaeff", &MODEL_PARAMS::createBetaEff,"model voigt");

      registry.connect("Yeff", Yeff,"model voigt");
      registry.connect("Geff", Geff,"model voigt");
      registry.connect("betaeff", betaeff,"model voigt");
